    ...
    if clientID>-1
        ...
        while (vrep.simxGetConnectionId(clientID)~=-1)
         ...
         vrep.simxGetPingTime(clientID);
            ...
            [pid1, joint1_pos(i)] = myPID_sine(clientID,vrep,joint1,45,pi,20,0,0,N,dt,i);
            [pid2, joint2_pos(i)] = myPID_sine(clientID,vrep,joint2,10,pi/2,15,0,0.01,N,dt,i);
            [pid3, joint3_pos(i)] = myPID_sine(clientID,vrep,joint3,30,pi/2,8,0.5,0.4,N,dt,i);
            [pid4, joint4_pos(i)] = myPID_sine(clientID,vrep,joint4,30,pi/3,6,0.1,0.2,N,dt,i);
            [pid5, joint5_pos(i)] = myPID_sine(clientID,vrep,joint5,90,3*pi/2,100,150,0.5,N,dt,i);
            [pid6, joint6_pos(i)] = myPID_sine(clientID,vrep,joint6,45,pi,10,0.1,0,N,dt,i);
            [pid7, joint7_pos(i)] = myPID_sine(clientID,vrep,joint7,45,2*pi,100,10,0.1,N,dt,i);
